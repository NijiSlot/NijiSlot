...
import 'package:rains/model/entities/movie_entity.dart';
...
class MovieWidget extends StatelessWidget {
    ...
    return Container(
      child: TextButton(
        child: Container(
          child: Column(
            children: [
              Expanded(child: Container(child: _buildThumbWidget())),
              Row(
                children: [
                  Expanded(
                    child: Container(
  ...
  Widget _buildThumbWidget() {
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.all(Radius.circular(4)),
        child: AppCacheImage(url: movie?.posterUrl ?? '', fit: BoxFit.cover),
      ),
    );
  }
}
